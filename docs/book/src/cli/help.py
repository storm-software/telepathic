...
def preprocess_help(s: str):
    ...
    s = re.sub(r"default: /.*/telepathic", "default: <CACHE_DIR>", s)
    # Remove the commit SHA and target architecture triple
    s = re.sub(r"default: telepathic/.*-[0-9A-Fa-f]{6,10}/\w+-\w*-\w+", "default: telepathic/<VERSION>-<SHA>/<ARCH>", s)
    # Remove the OS
    s = re.sub(r"default: telepathic/.*/\w+", "default: telepathic/<VERSION>/<OS>", s)
