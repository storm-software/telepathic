...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  "telepathic-napi-rs.wasm32-wasi.debug.wasm"
);
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve("@telepathic/bindings-wasm32-wasi/telepathic-napi-rs.wasm32-wasi.wasm");
  } catch {
    throw new Error(
      "Cannot find telepathic-napi-rs.wasm32-wasi.wasm file, and @telepathic/bindings-wasm32-wasi package is not installed."
    );
  }
}
