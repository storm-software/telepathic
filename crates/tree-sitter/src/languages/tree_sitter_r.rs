...
pub const HIGHLIGHTS_SCM_QUERY: &str = include_str!("../../grammars/r/queries/highlights.scm");
pub const LOCALS_SCM_QUERY: &str = include_str!("../../grammars/r/queries/locals.scm");
pub const TAGS_SCM_QUERY: &str = include_str!("../../grammars/r/queries/tags.scm");
