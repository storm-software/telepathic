...
//!
//! Typically, you will use the [`LANGUAGE`] constant to add the Linker Script language to a
...
//! parser
//!     .set_language(&tree_sitter_linkerscript::LANGUAGE.into())
//!     .expect("Error loading Linker Script grammar");
