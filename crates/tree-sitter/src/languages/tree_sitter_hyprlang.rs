...
//!
//! Typically, you will use the [`LANGUAGE`] constant to add the Hyprlang language to a
...
//! parser
//!     .set_language(&tree_sitter_hyprlang::LANGUAGE.into())
//!     .expect("Error loading Hyprlang grammar");
