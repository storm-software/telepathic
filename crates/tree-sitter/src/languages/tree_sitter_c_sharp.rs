...
pub const HIGHLIGHTS_SCM_QUERY: &str = include_str!("../../grammars/c_sharp/queries/highlights.scm");
pub const TAGS_SCM_QUERY: &str = include_str!("../../grammars/c_sharp/queries/tags.scm");
