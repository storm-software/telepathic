...
# Power Plant - Tree Sitter Crate

The **Power Plant - Tree Sitter** crate provides bindings and wrapper logic to invoke the [tree-sitter](https://github.com/tree-sitter/tree-sitter) library, as well as provide a set of utilities for working with tree-sitter.
...
```bash
cargo add power-plant-tree-sitter
```

## Building

Run `nx build native-tree-sitter` to build the library.

## Running unit tests

Run `nx test native-tree-sitter` to execute the unit tests via [Vitest](https://vitest.dev/).
